...
const homepagepath = ["/spreadsheet/demos/", "/development/spreadsheet/net10/demos/", "/release/spreadsheet/net10/demos/", "/hotfix/spreadsheet/net10/demos/", "/"];
...
function homePageAssets() {
    ...
    if (data.configuration == "Release") {
        assetFiles = [
            'https://cdn.syncfusion.com/blazor/documentprocessing-sb/spreadsheet/favicon.ico'
        ];
    }
...
function samplePageAssets() {
    ...
    if (data.configuration == "Release") {
        assetFiles = [
            'https://cdn.syncfusion.com/blazor/documentprocessing-sb/spreadsheet/favicon.ico',
            'https://cdn.syncfusion.com/blazor/documentprocessing-sb/spreadsheet/styles/32.1.19/common/roboto.min.css',
            'https://cdn.syncfusion.com/blazor/documentprocessing-sb/spreadsheet/scripts/32.1.19/highlight.min.js'
        ];
    }
    else if (data.configuration == "Staging") {
        assetFiles = [
