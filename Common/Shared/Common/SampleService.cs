...
namespace BlazorDemos.Shared
{
    ...
    public class SampleService
    {
        ...
        {
            var Navigation_Url = SampleUtils.IsHomePage(UriHelper) ?  UriHelper.BaseUri + "spreadsheet/overview/" : UriHelper.Uri;
#if DEBUG || STAGING
    #if NET8_0
        #if SERVER
        ...
        internal void UpdateFooter(string? currentUrl)
        {
            ...
            else
            {
                ...
                this.DocumentLink = "https://help.syncfusion.com/document-processing/excel/" + DocLink;
            }
        }
